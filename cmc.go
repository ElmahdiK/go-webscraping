...
func main() {
   ...
   c.Visit("https://coinmarketcap.com/fr/?page="+page)
...
func getGithub(link string) []gitLink {
	...
	g.OnRequest(func(l *colly.Request) {
		if (strings.Contains(l.URL.String(), "github")){
			...
			gitLinks = append(gitLinks, gitLink{Username:split[3], Link:getGitHubAPILink(split[3])})
		}
	})
...
func getGitHubAPILink(username string) string {
